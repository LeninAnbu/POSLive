...
class OpenInWardLineAPi {
  static Future<OpenStockOutLineModl> getGlobalData(
    ...
    try {
      ...
      log("Inward Search line Res: ${json.decode(response.body)}");
