...
class BillingOptRet extends StatelessWidget {
  const BillingOptRet(
      {super.key, required this.theme, required this.salesReturnController});
                      ...
                      builder: (BuildContext context) {
                        return AlertDialog(
                            ...
                            content: AlertBox(
                                payMent: 'Draft bills',
                                buttonName: null,
                                widget: salesReturnController.onHold.isEmpty
                                    ? ContentContainer(
