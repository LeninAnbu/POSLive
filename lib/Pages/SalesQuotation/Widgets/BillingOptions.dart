...
class SQBillingOptions extends StatelessWidget {
  const SQBillingOptions(
      {super.key, required this.theme, required this.sqController});

  final ThemeData theme;
  final SalesQuotationCon sqController;
  @override
                      ...
                      builder: (BuildContext context) {
                        return AlertDialog(
                            ...
                            content: AlertBox(
                                payMent: 'Draft bills',
                                buttonName: null,
                                widget: sqController.onHold.isEmpty
                                    ? ContentContainer(
