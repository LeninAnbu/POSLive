...
import '../../Service/NewReportsApi/TRAInvoicesApi.dart';
import '../../../../Widgets/Drawer.dart';
import 'package:intl/intl.dart';

class TRAInvoicesUserSpecific extends StatefulWidget {
  TRAInvoicesUserSpecific({super.key});
...
class _TRAInvoicesUserSpecificState extends State<TRAInvoicesUserSpecific> {
  ...
  callTestApi() async {
    loadingscrn = true;
    tablerColumn = [];
    await CreateTableApi.getGlobalData(
      fromDate,
      toDate,
    ).then((value) {
  ...
  List<DataRow> _generateRows(List<TestModelData> data) {
    ...
    data.forEach((item) {
      ...
      cells.add(DataCell(Container(
          alignment: Alignment.centerRight, child: Text(item.Tax.toString()))));
      cells.add(DataCell(Container(
          alignment: Alignment.centerRight,
      ...
      cells.add(DataCell(Container(
          alignment: Alignment.center, child: Text(item.canceled.toString()))));
      cells.add(DataCell(Text(item.Name.toString())));
      cells.add(DataCell(Text(item.whsBranch.toString())));
