...
//
//     final SapReturnCreditModel = SapReturnCreditModelFromJson(jsonString);

import '../ErrorModell/ErrorModelSl.dart';

// SapReturnCreditModel SapReturnCreditModelFromJson(String str) => SapReturnCreditModel.fromJson(json.decode(str));

// String SapReturnCreditModelToJson(SapReturnCreditModel data) => json.encode(data.toJson());

class SapReturnCreditModel {
  int stsCode;
  ErrorModel? erroe;
  ...
  int? docEntry;
  int? docNum;
  List<CreditDocumentLine>? documentLines;
  // String docType;
  // String handWritten;
  // String printed;
  // DateTime docDate;
  ...
  factory SapReturnCreditModel.fromJson(
          Map<String, dynamic> json, int stsCodee) =>
      SapReturnCreditModel(
        stsCode: stsCodee,
        erroe: null,
        ...
        documentLines: List<CreditDocumentLine>.from(
            json["DocumentLines"].map((x) => CreditDocumentLine.fromJson(x))),
  ...
  factory SapReturnCreditModel.issue(Map<String, dynamic> json, int stsCodee) =>
      SapReturnCreditModel(
        stsCode: stsCodee,
        erroe: ErrorModel.fromJson(json['error']),
        // odataMetadata: json["odata.metadata"],
        // odataEtag: json["odata.etag"],
        docEntry: null,
        docNum: null,
  ...
  factory SapReturnCreditModel.error(String n, int stsCodee) =>
      SapReturnCreditModel(
        stsCode: stsCodee,
        docEntry: 0,
        docNum: 0,
...
class CreditDocumentLine {
  ...
  // int docEntry;
  // dynamic surpluses;
  // dynamic defectAndBreakup;
  // dynamic shortages;
  // String considerQuantity;
  // String partialRetirement;
  // dynamic retirementQuantity;
  // dynamic retirementApc;
  // String thirdParty;
  // dynamic poNum;
  // dynamic poItmNum;
  // dynamic expenseType;
  ...
  factory CreditDocumentLine.fromJson(Map<String, dynamic> json) =>
      CreditDocumentLine(
        ...
        // enableReturnCost: json["EnableReturnCost"],
        ...
        // changeInventoryQuantityIndependently: json["ChangeInventoryQuantityIndependently"],
        ...
        // documentLinesBinAllocations: List<dynamic>.from(json["DocumentLinesBinAllocations"].map((x) => x)),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "Quantity": quantity,
        // "ShipDate": "${shipDate.year.toString().padLeft(4, '0')}-${shipDate.month.toString().padLeft(2, '0')}-${shipDate.day.toString().padLeft(2, '0')}",
        // "Price": price,
        ...
        // "DocumentLinesBinAllocations": List<dynamic>.from(documentLinesBinAllocations.map((x) => x)),
      };
}
