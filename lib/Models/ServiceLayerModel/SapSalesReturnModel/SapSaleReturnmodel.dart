...
//
  factory SapSalesReturnModel.fromJson(
      ...
      SapSalesReturnModel(
        ...
        returnvalue: List<ReturnDocumentLine>.from(
            json["DocumentLines"].map((x) => ReturnDocumentLine.fromJson(x))),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "DocumentLines":
            List<dynamic>.from(returnvalue!.map((x) => x.toJson())),
      };
}
