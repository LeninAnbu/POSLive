...
class Servicrlayerquotation {
  ...
  Map<String, dynamic> toJson() => {
        ...
        "DocumentLines":
            List<QuotDocumentLine>.from(documentLines!.map((x) => x.toJson())),
        // "ElectronicProtocols":
...
class QuotDocumentLine {
  ...
  factory QuotDocumentLine.fromJson(Map<String, dynamic> json) =>
      QuotDocumentLine(
        docEntry: json["DocEntry"] ?? 0,
        ...
        price: json["Price"] ?? 0,
        priceAfterVat: json["PriceAfterVAT"] ?? 0,
        ...
        commisionPercent: json["CommisionPercent"] ?? 0,
        ...
        baseOpenQuantity: json["BaseOpenQuantity"] ?? 0,
