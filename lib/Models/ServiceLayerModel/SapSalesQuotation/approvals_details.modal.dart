import 'package:posproject/Models/ServiceLayerModel/SapSalesQuotation/GetQuotsforPutModel.dart';

class ApprovalDetailsPutValue {
  int? statusCode;
  String? error;
  ...
  factory ApprovalDetailsPutValue.fromJson(dynamic json, int stsCode) {
    ...
    final dataList = list
        .map(
            (dynamic enquiries) => DocumentApprovalPutValue.fromJson(enquiries))
        .toList();
    ...
    return ApprovalDetailsPutValue(
      ...
      numAtCard: json['NumAtCard']?.toString(),
      ...
      uOrderDate: json['U_OrderDate']?.toString(),
  ...
  factory ApprovalDetailsPutValue.issue(String e) {
    return ApprovalDetailsPutValue(
      error: e,
    );
  }
...
class DocumentApprovalPutValue {
  int? lineNum;
  String? itemCode;
  ...
  factory DocumentApprovalPutValue.fromJson(dynamic json) =>
      DocumentApprovalPutValue(
        ...
        lengh2Unit: json['Lengh2Unit']?.toString(),
        ...
        deferredTax: json['DeferredTax']?.toString(),
        equalizationTaxPercent: json['EqualizationTaxPercent'] == null
            ? null
        ...
        totalEqualizationTaxSc: json['TotalEqualizationTaxSC'] == null
            ? null
            : double.parse(json['TotalEqualizationTaxSC'].toString()),
        netTaxAmount: json['NetTaxAmount'] == null
            ? null
            : double.parse(json['NetTaxAmount'].toString()),
        netTaxAmountFc: json['NetTaxAmountFC'] == null
            ? null
            : double.parse(json['NetTaxAmountFC'].toString()),
        netTaxAmountSc: json['NetTaxAmountSC'] == null
            ? null
            : double.parse(json['NetTaxAmountSC'].toString()),
        measureUnit: json['MeasureUnit']?.toString(),
        unitsOfMeasurment: json['UnitsOfMeasurment'] == null
            ? null
            : double.parse(json['UnitsOfMeasurment'].toString()),
        lineTotal: json['LineTotal'] == null
            ? null
            : double.parse(json['LineTotal'].toString()),
        taxPercentagePerRow: json['TaxPercentagePerRow'] == null
            ? null
            : double.parse(json['TaxPercentagePerRow'].toString()),
        taxTotal: json['TaxTotal'] == null
            ? null
            : double.parse(json['TaxTotal'].toString()),
        consumerSalesForecast: json['ConsumerSalesForecast']?.toString(),
        exciseAmount: json['ExciseAmount'] == null
            ? null
            : double.parse(json['ExciseAmount'].toString()),
        totalInclTax: json['TotalInclTax'] == null
            ? null
            : double.parse(json['TotalInclTax'].toString()),
        countryOrg: json['CountryOrg'],
        sww: json['SWW']?.toString(),
        transactionType: json['TransactionType']?.toString(),
        distributeExpense: json['DistributeExpense']?.toString(),
        rowTotalFc: json['RowTotalFC'] == null
            ? null
            : double.parse(json['RowTotalFC'].toString()),
        rowTotalSc: json['RowTotalSC'] == null
            ? null
            : double.parse(json['RowTotalSC'].toString()),
        lastBuyInmPrice: json['LastBuyInmPrice'] == null
            ? null
            : double.parse(json['LastBuyInmPrice'].toString()),
        lastBuyDistributeSumFc: json['LastBuyDistributeSumFc'] == null
            ? null
            : double.parse(json['LastBuyDistributeSumFc'].toString()),
        lastBuyDistributeSumSc: json['LastBuyDistributeSumSc'] == null
            ? null
            : double.parse(json['LastBuyDistributeSumSc'].toString()),
        lastBuyDistributeSum: json['LastBuyDistributeSum'] == null
            ? null
            : double.parse(json['LastBuyDistributeSum'].toString()),
        stockDistributesumForeign: json['StockDistributesumForeign'] == null
            ? null
            : double.parse(json['StockDistributesumForeign'].toString()),
        stockDistributesumSystem: json['StockDistributesumSystem'] == null
            ? null
            : double.parse(json['StockDistributesumSystem'].toString()),
        stockDistributesum: json['StockDistributesum'] == null
            ? null
            : double.parse(json['StockDistributesum'].toString()),
        stockInmPrice: json['StockInmPrice'] == null
            ? null
            : double.parse(json['StockInmPrice'].toString()),
        pickStatusEx: json['PickStatusEx']?.toString(),
        taxBeforeDpm: json['TaxBeforeDPM'] == null
            ? null
            : double.parse(json['TaxBeforeDPM'].toString()),
        taxBeforeDpmfc: json['TaxBeforeDPMFC'] == null
            ? null
            : double.parse(json['TaxBeforeDPMFC'].toString()),
        taxBeforeDpmsc: json['TaxBeforeDPMSC'] == null
            ? null
            : double.parse(json['TaxBeforeDPMSC'].toString()),
        ...
        visualOrder: json['VisualOrder'] == null
            ? null
            : int.parse(json['VisualOrder'].toString()),
        baseOpenQuantity: json['BaseOpenQuantity'] == null
            ? null
            : double.parse(json['BaseOpenQuantity'].toString()),
        ...
        packageQuantity: json['PackageQuantity'] == null
            ? null
            : double.parse(json['PackageQuantity'].toString()),
        ...
        changeAssemlyBoMWarehouse:
            json['ChangeAssemlyBoMWarehouse']?.toString(),
        grossBuyPrice: json['GrossBuyPrice'] == null
            ? null
            : double.parse(json['GrossBuyPrice'].toString()),
        grossBase: json['GrossBase'] == null
            ? null
            : int.parse(json['GrossBase'].toString()),
        grossProfitTotalBasePrice: json['GrossProfitTotalBasePrice'] == null
            ? null
        ...
        remainingOpenQuantity: json['RemainingOpenQuantity'] == null
            ? null
            : double.parse(json['RemainingOpenQuantity'].toString()),
        openAmount: json['OpenAmount'] == null
            ? null
            : double.parse(json['OpenAmount'].toString()),
        openAmountFc: json['OpenAmountFC'] == null
            ? null
            : double.parse(json['OpenAmountFC'].toString()),
        openAmountSc: json['OpenAmountSC'] == null
            ? null
            : double.parse(json['OpenAmountSC'].toString()),
        exLineNo: json['ExLineNo'],
        Date: json[' RequiredDate'],
        requiredQuantity: json['RequiredQuantity'] == null
            ? null
            : double.parse(json['RequiredQuantity'].toString()),
        ...
        docEntry: json['DocEntry'] == null
            ? null
            : int.parse(json['DocEntry'].toString()),
        surpluses: json['Surpluses'] == null
            ? null
            : double.parse(json['Surpluses'].toString()),
        defectAndBreakup: json['DefectAndBreakup'] == null
            ? null
            : double.parse(json['DefectAndBreakup'].toString()),
        shortages: json['Shortages'] == null
            ? null
            : double.parse(json['Shortages'].toString()),
        considerQuantity: json['ConsiderQuantity']?.toString(),
        partialRetirement: json['PartialRetirement']?.toString(),
        retirementQuantity: json['RetirementQuantity'] == null
            ? null
            : double.parse(json['RetirementQuantity'].toString()),
        retirementApc: json['RetirementAPC'] == null
            ? null
            : double.parse(json['RetirementAPC'].toString()),
        ...
        grossProfit: json['GrossProfit'] == null
            ? null
            : double.parse(json['GrossProfit'].toString()),
        grossProfitFc: json['GrossProfitFC'] == null
            ? null
            : double.parse(json['GrossProfitFC'].toString()),
        grossProfitSc: json['GrossProfitSC'] == null
            ? null
            : double.parse(json['GrossProfitSC'].toString()),
        priceSource: json['PriceSource']?.toString(),
        stgSeqNum: json['StgSeqNum'],
        stgEntry: json['StgEntry'],
        stgDesc: json['StgDesc'],
        uoMEntry: json['UoMEntry'] == null
            ? null
            : int.parse(json['UoMEntry'].toString()),
        uoMCode: json['UoMCode']?.toString(),
        inventoryQuantity: json['InventoryQuantity'] == null
            ? null
            : double.parse(json['InventoryQuantity'].toString()),
        remainingOpenInventoryQuantity:
            json['RemainingOpenInventoryQuantity'] == null
                ? null
                : double.parse(
                    json['RemainingOpenInventoryQuantity'].toString()),
        parentLineNum: json['ParentLineNum']?.toString(),
        incoterms: json['Incoterms'] == null
            ? null
            : int.parse(json['Incoterms'].toString()),
        transportMode: json['TransportMode'] == null
            ? null
            : int.parse(json['TransportMode'].toString()),
        ...
        grossPrice: json['GrossPrice'] == null
            ? null
            : double.parse(json['GrossPrice'].toString()),
        grossTotal: json['GrossTotal'] == null
            ? null
            : double.parse(json['GrossTotal'].toString()),
        grossTotalFc: json['GrossTotalFC'] == null
            ? null
            : double.parse(json['GrossTotalFC'].toString()),
        grossTotalSc: json['GrossTotalSC'] == null
            ? null
            : double.parse(json['GrossTotalSC'].toString()),
        ncmCode: json['NCMCode'] == null
            ? null
            : int.parse(json['NCMCode'].toString()),
        nveCode: json['NVECode'],
        indEscala: json['IndEscala']?.toString(),
        ctrSealQty: json['CtrSealQty'] == null
            ? null
            : double.parse(json['CtrSealQty'].toString()),
        cnjpMan: json['CNJPMan'],
        cestCode: json['CESTCode'] == null
            ? null
            : int.parse(json['CESTCode'].toString()),
        ufFiscalBenefitCode: json['UFFiscalBenefitCode'],
        shipToCode: json['ShipToCode'] != null || json['ShipToCode'] != 'null'
            ? null
            : json['ShipToCode'].toString(),
        shipToDescription: json['ShipToDescription']?.toString(),
        externalCalcTaxRate: json['ExternalCalcTaxRate'] == null
            ? null
            : double.parse(json['ExternalCalcTaxRate'].toString()),
        externalCalcTaxAmount: json['ExternalCalcTaxAmount'] == null
            ? null
            : double.parse(json['ExternalCalcTaxAmount'].toString()),
        externalCalcTaxAmountFc: json['ExternalCalcTaxAmountFC'] == null
            ? null
            : double.parse(json['ExternalCalcTaxAmountFC'].toString()),
        externalCalcTaxAmountSc: json['ExternalCalcTaxAmountSC'] == null
            ? null
            : double.parse(json['ExternalCalcTaxAmountSC'].toString()),
        standardItemIdentification: json['StandardItemIdentification'] == null
            ? null
        ...
        taxPerUnit: json['TaxPerUnit'] == null
            ? null
            : double.parse(json['TaxPerUnit'].toString()),
