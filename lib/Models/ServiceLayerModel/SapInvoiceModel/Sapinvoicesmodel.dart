...
class SapSalesinvoiceModel {
  ...
  factory SapSalesinvoiceModel.fromJson(
    ...
    return SapSalesinvoiceModel(
      ...
      documentLines: List<InvoiceDocumentLine>.from(
  ...
  factory SapSalesinvoiceModel.issue(
...
class DocumentInstallment {
  ...
  factory DocumentInstallment.fromJson(Map<String, dynamic> json) =>
      DocumentInstallment(
...
class BatchNumber {
  ...
  Map<String, dynamic> toJson() => {
        ...
        "AddmisionDate":
            "${addmisionDate.year.toString().padLeft(4, '0')}-${addmisionDate.month.toString().padLeft(2, '0')}-${addmisionDate.day.toString().padLeft(2, '0')}",
        "Location": location,
        "Notes": notes,
        "Quantity": quantity,
