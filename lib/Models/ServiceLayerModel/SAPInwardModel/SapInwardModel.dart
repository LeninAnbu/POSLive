...
//
//     final sapInwardModel = sapInwardModelFromJson(jsonString);

import '../ErrorModell/ErrorModelSl.dart';

// SapInwardModel sapInwardModelFromJson(String str) => SapInwardModel.fromJson(json.decode(str));

// String sapInwardModelToJson(SapInwardModel data) => json.encode(data.toJson());

class SapInwardModel {
  ErrorModel? error;
  int? statusCode;
  ...
  int docEntry;
  int docNum;
  List<StockTransferInwrddLine> StockTransferInwrddLines;
  // List<BatchNumbers> batchNumber;
  ...
  SapInwardModel({
    ...
    required this.StockTransferInwrddLines,
    // required this.stockTransferTaxExtension,
    // required this.documentReferences,
  });

  factory SapInwardModel.fromJson(Map<String, dynamic> json, int stscode) {
    // jsonDecode(jsons["data"]) as List;
    //  json.decode(json["StockTransferInwrddLines"])));
    return SapInwardModel(
      docEntry: json["DocEntry"] ?? '',
      docNum: json["DocNum"] ?? '',
      StockTransferInwrddLines: List<StockTransferInwrddLine>.from(
          json["StockTransferLines"]
              .map((x) => StockTransferInwrddLine.fromJson(x))),
      error: null,
      statusCode: stscode,
      ...
      // stockTransferApprovalRequests: List<dynamic>.from(
      //     json["StockTransfer_ApprovalRequests"].map((x) => x)),
      // electronicProtocols:
      //     List<dynamic>.from(json["ElectronicProtocols"].map((x) => x)),

      // stockTransferTaxExtension: StockTransferTaxExtension.fromJson(
      //     json["StockTransferTaxExtension"]),
      // documentReferences:
      //     List<dynamic>.from(json["DocumentReferences"].map((x) => x)),
    );
  }
  factory SapInwardModel.issue(Map<String, dynamic> json, int statuscode) {
    return SapInwardModel(
  ...
  Map<String, dynamic> toJson() => {
        ...
        "StockTransferLines":
            List<dynamic>.from(StockTransferInwrddLines.map((x) => x.toJson())),
        // "Series": series,
        // "Printed": printed,
        // "DocDate":
        ...
        //     List<dynamic>.from(stockTransferApprovalRequests.map((x) => x)),
        // "ElectronicProtocols":
...
class StockTransferInwrddLine {
  ...
  // List<dynamic> StockTransferInwrddLinesBinAllocations;

  StockTransferInwrddLine({
    ...
    // required this.StockTransferInwrddLinesBinAllocations,
  });

  factory StockTransferInwrddLine.fromJson(Map<String, dynamic> json) =>
      StockTransferInwrddLine(
        ...
        price: json["Price"] ?? '',
        batchNumbers: List<BatchNumbers>.from(
            json["BatchNumbers"].map((x) => BatchNumbers.fromJson(x))),
        ...
        // uPackSize: json["U_PackSize"]?.toDouble(),
        ...
        // StockTransferInwrddLinesBinAllocations: List<dynamic>.from(
        //     json["StockTransferInwrddLinesBinAllocations"].map((x) => x)),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "BatchNumbers": List<BatchNumbers>.from(batchNumbers.map((x) => x)),
        // "CCDNumbers": List<dynamic>.from(ccdNumbers.map((x) => x)),
        // "StockTransferInwrddLinesBinAllocations":
        //     List<dynamic>.from(StockTransferInwrddLinesBinAllocations.map((x) => x)),
      };
}
...
class BatchNumbers {
  ...
  factory BatchNumbers.fromJson(Map<String, dynamic> json) => BatchNumbers(
