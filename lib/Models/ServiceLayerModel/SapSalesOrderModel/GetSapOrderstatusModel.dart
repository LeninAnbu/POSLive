...
//
//     final sapSalesOrderModel = sapSalesOrderModelFromJson(jsonString);
...
class SapSalesOrderModel {
  ...
  // double docRate;
  // String reference1;
  List<OrderDocumentLine> documentLines;
  ...
  factory SapSalesOrderModel.fromJson(
      ...
      SapSalesOrderModel(
        ...
        documentLines: List<OrderDocumentLine>.from(
            json["DocumentLines"].map((x) => OrderDocumentLine.fromJson(x))),
        ...
        // cancelDate: DateTime.parse(json["CancelDate"]),
  ...
  factory SapSalesOrderModel.issue(Map<String, dynamic> json, int statuscode) {
  ...
  Map<String, dynamic> toJson() => {
        ...
        // "CancelDate": "${cancelDate.year.toString().padLeft(4, '0')}-${cancelDate.month.toString().padLeft(2, '0')}-${cancelDate.day.toString().padLeft(2, '0')}",
