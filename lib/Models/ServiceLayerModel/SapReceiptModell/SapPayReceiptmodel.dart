...
//
//     final ServicrlayerReceipt = ServicrlayerReceiptFromJson(jsonString);


import 'package:posproject/Models/ServiceLayerModel/ErrorModell/ErrorModelSl.dart';

// ServicrlayerReceipt ServicrlayerReceiptFromJson(String str,int stcode) =>
//     ServicrlayerReceipt.fromJson(json.decode(str,stcode));

// String ServicrlayerReceiptToJson(ServicrlayerReceipt data) =>
//     json.encode(data.toJson());

class ServicrlayerReceipt {
  ErrorModel? error;
  int? statusCode;
  ...
  double docRate;
  String reference1;
  List<ReceiptDocumentLine> ReceiptDocumentLines;
  ...
  ServicrlayerReceipt({
    ...
    required this.ReceiptDocumentLines,
    ...
    // required this.documentReferences, ErrorModel.fromJson(json['error'])
  });

  factory ServicrlayerReceipt.fromJson(
      Map<String, dynamic> json, int statuscode) {
    return ServicrlayerReceipt(
      ...
      ReceiptDocumentLines: List<ReceiptDocumentLine>.from(
          json["ReceiptDocumentLines"].map((x) => ReceiptDocumentLine.fromJson(x))),
      error: null,
  ...
  factory ServicrlayerReceipt.issue(Map<String, dynamic> json, int statuscode) {
    return ServicrlayerReceipt(
      statusCode: statuscode,
      odataMetadata: '',
      odataEtag: '',
  ...
  Map<String, dynamic> toJson() => {
        ...
        "ReceiptDocumentLines":
            List<dynamic>.from(ReceiptDocumentLines.map((x) => x.toJson())),
        // "ElectronicProtocols":
...
class ReceiptDocumentLine {
  ...
  // List<dynamic> ReceiptDocumentLineAdditionalExpenses;
  ...
  ReceiptDocumentLine({
    ...
    // required this.ReceiptDocumentLineAdditionalExpenses,
  });

  factory ReceiptDocumentLine.fromJson(Map<String, dynamic> json) => ReceiptDocumentLine(
        ...
        // ReceiptDocumentLineAdditionalExpenses: List<dynamic>.from(
        //     json["ReceiptDocumentLineAdditionalExpenses"].map((x) => x)),
      );
  Map<String, dynamic> toJson() => {
        "LineNum": lineNum,
        "ItemCode": itemCode,
        ...
        // "ReceiptDocumentLineAdditionalExpenses":
        //     List<dynamic>.from(ReceiptDocumentLineAdditionalExpenses.map((x) => x)),
      };
}
